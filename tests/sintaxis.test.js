...
const assetsVersionados = ['styles.css', 'data.js', 'engine.js', 'app.js', 'app-session.js', 'marketplace.js', 'render-main.js', 'render-agenda.js', 'icon.svg', 'icon-192.png', 'logo.svg'];
...
if (!/for asset in styles\.css data\.js engine\.js app\.js app-session\.js marketplace\.js render-main\.js render-agenda\.js icon\.svg icon-192\.png logo\.svg; do/.test(deployYml) ||
