...
if (!html.includes('href="styles.css"') || !html.includes('src="app.js"') || !html.includes('src="render-agenda.js"') || !html.includes('src="engine.js"') || !html.includes('src="data.js"')) {
...
if (html.indexOf('src="data.js"') > html.indexOf('src="engine.js"') || html.indexOf('src="engine.js"') > html.indexOf('src="app.js"') || html.indexOf('src="app.js"') > html.indexOf('src="render-agenda.js"')) {
  console.error('index.html debe cargar data.js, engine.js, app.js y render-agenda.js en ese orden');
  process.exit(1);
}
