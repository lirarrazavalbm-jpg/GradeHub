...
chk('QIM100F detecta examen condicional y fórmula alternativa',
  reason(qim,'conditional_exam_rule_detected')&&reason(qim,'alternative_final_grade_formula_detected'));
chk('QIM100F conserva las líneas que activaron la revisión',qim.complexRuleLines.length===2&&/70% nota/.test(qim.complexRuleLines[1].line));
